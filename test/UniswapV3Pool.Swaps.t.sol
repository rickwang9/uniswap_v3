...
// forge test --match-path ./test/UniswapV3Pool.Swaps.t.sol --match-contract UniswapV3PoolSwapsTest --match-test "testBuyETHOnePriceRange*" -vvv
    //  One price range
    //
    //          5000
    //  4545 -----|----- 5500
...
// forge test --match-path ./test/UniswapV3Pool.Swaps.t.sol --match-contract UniswapV3PoolSwapsTest --match-test "testBuyETHConsecutivePriceRanges*" -vvv
